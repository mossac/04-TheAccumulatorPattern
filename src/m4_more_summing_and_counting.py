...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Aidan.
...
def run_test_count_cosines_from():
    ...
    print('       actual:  ', answer)
    expected = 0
    answer = count_cosines_from(3, 4, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)
    expected = 1
    answer = count_cosines_from(9, 9, -1)
...
def run_test_sum_unit_fractions_from():
    ...
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    expected = .8333  # This is APPROXIMATELY the correct answer.
